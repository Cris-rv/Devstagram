...
@section('contenido')
    ...
    <div class="flex justify-start">
        <div class="w-full md:w-8/12 lg:w-6/12 flex flex-col items-center md:flex-row">
            <div class="w-8/12 lg:w-6/12 px-0 me-10">
                <img src="{{
                     $user->imagen ?
                ...
                <div class="flex items-center gap-2">
                    <p class="text-gray-700 text-2xl mt-5">{{ $user->username }}</p>
                        @auth
                            ...
                            class="text-grade-500 hover:text-gray-600 cursor-pointer"
                            >
                    ...
                    @if ($user->id !== auth()->user()->id)
                        @if (!$user->siguiendo( auth()->user() ) )
                            ...
                            >
                                ...
                                <input 
                                type="submit" 
                                class="bg-blue-600 text-white uppercase rounded-lg px-4 py-1 text-xs font-bold cursor-pointer mb-2"
                                value="Seguir"
                                >
                            </form>
                        @else
